...
import { addAnswers, addQuestions, addReplyToReview, addReview, deletCourse, editCourse, getAllCourse, getCourseByValidUser, getSingleCourse, uploadCourse } from './course.controller';
